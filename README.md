...
bug fix= if the user is not logged in redirect/browsw   to login page and vice versa
...
tailwind class to mahe main container look awesme
build secondary component
build movie list
build movie card
TMDb Image cdn Url
made the browser page amazing with tailwind css
usePoplartmovies custum hook
search page
search bar
